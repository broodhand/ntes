...
#Get the data which from neteast stock api
class Ntes_tick(object):
    
    #Get the code stocks' code for the class's initial property
    def __init__(self,code):
        self.code = code
    
    #Get the json data from neteast api 
    @property    
    def value(self):
    ...
    #Get the value from neteast api.This is a generator.
    ...
    #Get the value form neteast api.This is a data stream.    
